                ...
                <div class="flex flex-col justify-center flex-1 min-w-0">
                    ...
                    <div ng-if="message.type == '1'">
                        <div class="flex items-center gap-2 min-w-0">
                            <span ng-show="message.is_sent_by_me" ng-class="{'text-primary': message.is_seen, 'text-slate-400': !message.is_seen}" class="material-symbols-outlined text-[14px] shrink-0">
                                done_all
                            </span>
                            ...
                            <div ng-show="message.unread" class="min-w-[20px] h-[20px] px-1 rounded-full bg-primary flex items-center justify-center shrink-0">
